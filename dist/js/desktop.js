...
define("templates/jst", function(){});

define('tools/videoLoader',[], function() {
...
define('views/home',['jquery', 'backbone', 'templates/jst', 'tools/videoLoader'], function($, Backbone, tmplts, VideoLoader) {
...
define('controllers/elements/book',['jquery', 'views/elements/book', 'tools/styleLoader'], function($, BookViewEl, StyleLoader) {
...
define('controllers/home',['views/home', 'controllers/elements/book', 'tools/urlTranslator'], 
        ...
        addBanner: function(images) {
            ...
            if('full' in images && typeof images.full === 'object') {
                if(parseInt(images.full.width) > minWidth) {
                    ...
                    SecondaryView.setBackgroundImage('/img/default-heading-bg.png');
                }
...
define('router',['backbone', 'jquery', 'controllers/home', 'controllers/secondary', 'controllers/category', 'libs/json2',
...
define('tools/mobileEvents',[], function() {
...
define('desktop',['libs/domReady', 'router', 'tools/mobileEvents'], function(domReady, Router, MobileEvents){
    domReady(function() {
